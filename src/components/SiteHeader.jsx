...
export default function SiteHeader() {
  ...
  return <header className={`nav-wrap ${menuOpen ? 'menu-open' : ''}`}>
    <nav className="nav container">
      ...
      <div className="nav-links">{sections.map(([, label, id]) => <SectionLink sectionId={id} key={id}>{label}</SectionLink>)}<a href="/case-study/">Case studies</a></div>
